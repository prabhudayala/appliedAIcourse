# -*- coding: utf-8 -*-
"""
Created on Fri Oct 19 23:15:32 2018
...
import pandas as pd
avg_sent_vectors = pickle.load(open('avg_word2vec_on_amazon_food_vectors50.sav', 'rb'))
#print(len(tfidf_sent_vectors))
#print(tfidf_sent_vectors[0])
d=pd.DataFrame(avg_sent_vectors[:200000])
